-- Solución definitiva para el error de assignment_type (CORREGIDA)
...
BEGIN
  ...
  IF EXISTS (
    ...
    -- Verificar si existe la columna assignment_type
    SELECT EXISTS (
...
BEGIN
  ...
  IF admin_id IS NOT NULL THEN
    ...
    LOOP
      RAISE NOTICE 'Asignación: % - Asignado a: % (%)', assignment_record.title, assignment_record.full_name, assignment_record.role;
    END LOOP;
  ELSE
