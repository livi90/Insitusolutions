-- Corregir estructura de work_assignments y eliminar referencias a columnas inexistentes
-- Versión corregida sin errores de sintaxis

-- ===== VERIFICAR Y CORREGIR ESTRUCTURA DE WORK_ASSIGNMENTS =====
DO $$
DECLARE
  col_exists BOOLEAN;
  rec RECORD;
...
-- Eliminar tabla existente y recrear con estructura limpia
...
BEGIN
  ...
  IF admin_id IS NOT NULL OR encargado_id IS NOT NULL THEN
    -- Limpiar asignaciones existentes para esta entrega
